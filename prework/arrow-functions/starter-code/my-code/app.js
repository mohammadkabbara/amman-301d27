...
//I think because of the different composition of writing the code so that it was written each time in a different way from the other, which led to different results
